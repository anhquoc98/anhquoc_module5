...
export function HealthDeclaration() {
    ...
    return (<>
        <Formik
            initialValues={{
                name: 'Nguyễn Văn A', cmnd: '1054841495', birthday: 1900,nationality:'Việt Nam',city:'Đà Nẵng',district:'Thanh Khê'
                ,wards:'abc',address:'cba',phone:'5214598741',email:'2548asd@gmail.com'
            }}
